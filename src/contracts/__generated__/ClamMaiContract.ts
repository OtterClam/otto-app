...
export interface ClamMaiContractInterface extends utils.Interface {
  functions: {
...
export interface ClamMaiContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ClamMaiContractInterface;
