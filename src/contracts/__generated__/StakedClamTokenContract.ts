...
export interface StakedClamTokenContractInterface extends utils.Interface {
  functions: {
...
export interface StakedClamTokenContract extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StakedClamTokenContractInterface;
