...
import LargeClamBg from './header_clam_normal_xl.png'
import LargeClamHoverBg from './header_clam_hover_xl.png'
import SmallClamBg from './header_clam_normal_xs.png'
import SmallClamHoverBg from './header_clam_hover_xs.png'
